...
import { parseQuickScoreTileImport, removeQuickScoreTileImport } from '../pages/QuickScorePage';
import {
...
describe('tile recognition pipeline', () => {
  ...
  it('round-trips recognition tiles into the quick-score import hash', () => {
    ...
    expect(removeQuickScoreTileImport('#/quick-score?tiles=m1%2Cz7&source=camera')).toBe('#/quick-score?source=camera');
  });
